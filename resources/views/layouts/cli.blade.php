...
<nav class="navbar navbar-dark info-color-dark ">
    <a class="navbar-brand " href="#">Aexoic assignment</a>
    <ul class="navbar-nav ml-auto nav-flex-icons">
        ...
        <!-- <form method="POST" action="">
                    @csrf
                    <a href="" id="logout_link" class="dropdown-item text-white">Logout<i class="fa fa-sign-out"></i></a>
                </form> -->
